...
class FlywayMigrationTests extends PostgresIntegrationTestSupport {
    ...
    void migrationsCreateCoreSchemaExtensionsAndSeededAdmin() throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            assertThat(tableNamesWithoutComments(connection)).doesNotContain("users", "articles", "portfolio_projects");
            assertThat(columnNamesWithoutComments(connection)).doesNotContain("users.username", "articles.title", "portfolio_projects.title");
