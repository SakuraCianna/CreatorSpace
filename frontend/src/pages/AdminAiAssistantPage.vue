...
import { fetchAdminArticles, fetchAdminComments, fetchAdminProjects, fetchAiSuggestions, fetchAiTask, fetchAiTasks, streamAiFollowUp, streamAiTask, streamAiWorkflow, updateAiSuggestionStatus } from '../services/content'
import { toUserMessage } from '../services/http'
import type { AiSuggestionStatus, AiSuggestionSummary, AiTaskPayload, AiTaskSummary, AiTaskType, ArticleSummary, CommentSummary, ProjectSummary, AiWorkflowPayload, PageResponse } from '../shared/domain'
type PickableTargetType = 'ARTICLE' | 'PROJECT' | 'COMMENT'
...
function refreshAiData() {
  void Promise.all([loadSuggestions(suggestions.value.page), loadTaskHistory()])
}
